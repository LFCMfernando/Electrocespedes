...
<html lang="en">
  <head>
    <title>Home Builder5 - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="<?php echo $url; ?>index.php" class="nav-link">Inicioo</a></li>
	          ...
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-12 ftco-animate">
		          	<div class="text w-100 text-center">
						<h2>PARA TU TRANQUILIDAD</h2>
			            <h1 class="mb-3">SOLUCIÓN EFICAZ</h1>
		            </div>
		          </div>
		        </div>
	        </div>
	          ...
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-12 ftco-animate">
		          	<div class="text w-100 text-center">
						...
						<h1 class="mb-3">PRODUCTOS DE </h1>
						<h1 class="mb-3">CALIDAD</h1>
		            </div>
		          </div>
		        </div>
	        </div>
	      ...
	      <div class="slider-item" style="background-image:url(images/bg_3.jpg);">
	        ...
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-12 ftco-animate">
		          	<div class="text w-100 text-center">
		          		<h2>ATENTOS PARA OFRECERTE UN</h2>
			            <h1 class="mb-3">SERVICIO</h1>
							<h1 class="mb-3">PROACTIVO</h1>
		            </div>
		          </div>
		        </div>
	        </div>
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 py-md-5 ftco-animate">
            <div class="media block-6 d-block text-center pt-md-4">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Trabajamos con un
					Stock amplio y variado
					para facilitar su tiempo</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 py-md-5 ftco-animate">
            <div class="media block-6 d-block text-center pt-md-4">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Nos preocupamos más que te
					vayas satisfecho con nuestra
					atención</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 py-md-5 ftco-animate">
            <div class="media block-6 d-block text-center pt-md-4">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Instalación o mantenimientos
					para el sector eléctrico</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 py-md-5 ftco-animate">
            <div class="media block-6 d-block text-center pt-md-4">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Nuestro nuevo servicio
					aumentara su productividad,
					ya que estará estructurado
					cada cliente meta</p>
              </div>
            </div>      
          </div>
    		...
    		<div class="row no-gutters">
    			<div class="col-md-12 col-lg-4 services-2 p-4 py-5 d-flex ftco-animate">
    				<div class="py-3 d-flex">
	    				...
	    				<div class="text">
	      				<h3>Experto &amp; Profesionales</h3>
	      				<p class="mb-0">Capacitados para una
							atención proactiva y un
							servicio eficaz
							</p>
	    				</div>
	    			</div>
    			...
    			<div class="col-md-12 col-lg-4 services-2 p-4 py-5 d-flex ftco-animate">
    				<div class="py-3 d-flex">
	    				...
	    				<div class="text">
	      				<h3>Alta Calidad </h3>
	      				<p class="mb-0">Trabajamos con
							distribuidoras autorizadas y
							poder ofrecer el verdadero
							producto con su respectiva
							garantia</p>
	      			</div>
	      		</div>
    			</div>
    			<div class="col-md-12 col-lg-4 services-2 p-4 py-5 d-flex ftco-animate">
    				<div class="py-3 d-flex">
	    				...
	    				<div class="text">
	      				<h3>24/7 Alquiler </h3>
	      				<p class="mb-0">Posibilitamos a que no pierda
							productividad alquilando
							suministros o equipos
							eléctricos: transformadores,
							grupo electrógeno, escaleras
							etc</p>
	      			</div>
	      		</div>
    			</div>
    		...
    		<div class="row d-flex no-gutters">
    			...
    			<div class="col-md-6 pl-md-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate pl-md-4 py-md-4">
		            ...
		            <p>Soy una Empresa que vende suministros y brinda servicio del sector
						eléctrico de baja y media tensión. Ofreciendo soluciones rápida y
						eficaces para tu tranquilidad en tu productividad.
						Con mas de 20 años trabajando con electricistas, ingenieros proyectistas y
						empresas grandes y pequeñas sean agroexportadoras o comerciales. Aun así
						velamos en seguir mejorando para poder dar una atención o servicio a la
						altura de tus expectativas. </p>
    				...
    				<div class="py-3">
						...
						<div class="desc w-100 px-4">
							<div class="text w-100 mb-3">
							  <!--<span>Building</span>-->
							  <h3><a href="<?php echo $url; ?>work-single.php">Texto de la categoria</a></h3>
							</div>
						</div>
	    			</div>
    			</div>
